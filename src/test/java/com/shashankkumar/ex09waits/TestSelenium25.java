...
public void testSeleniumwWait(){
        ...
        //or
     /*   WebElement errmsg = driver.findElement(By.xpath("//*[@data-qa='sibequkica']"));
        wait.until(ExpectedConditions.visibilityOf(errmsg));

      */
        //the result of the wait.until() method is a WebElement, which can then be used to interact with the found element, such as retrieving text, clicking, or other operations.
